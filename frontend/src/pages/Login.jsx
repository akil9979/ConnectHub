  ...
  return (
    <div className='min-h-screen bg-transparent flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8'>
      <div className='w-full max-w-md space-y-8'>
        ...
        <form action="" onSubmit={handleSignin} className='mt-8 bg-white/70 backdrop-blur-md py-8 px-4 shadow-[0_8px_30px_rgb(0,0,0,0.08)] sm:rounded-3xl sm:px-10 border border-white/60 flex flex-col gap-5 hover:bg-white/80 transition-all duration-300' >
